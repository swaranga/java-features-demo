...
/**
 * - Copy factories - Allows duplicates, but impl unspecified - Returns itself if unnecessary
 * 
 * - Collectors - Collect to Unmodifiable collections
 */
public class Java10 {
    ...
    private static void copyOf() {
        ...
        System.out.println("Map.copyOf(map) == map: " + (Map.copyOf(map) == map));
    }
